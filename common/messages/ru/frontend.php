...
return [
    ...
    'We already have a user with name {login}. You can login using email to link {provider} account.' =>'Пользователь с именем {login} уже зарегистрирован. Вы можете войти, используя email, чтобы привязать аккаунт {provider}.',
